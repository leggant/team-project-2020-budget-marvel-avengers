                ...
                @foreach ($cohort as $key => $value)
                    ...
                    <tr>
                        <form id="cohort-screenx" method="get" action="">
                            ...
                            <td>
                                <textarea id="cohort-input2" readonly="readonly" name="cohort-review" rows="4"
                                    cols="50">{{ $value->names }}</textarea>
                            </td>
                            <td>
                                <form>
                    ...
                    <tr>
                        <form id="cohort-screenx" method="get" action="">
                            ...
                            <td>
                                <textarea id="cohort-input1" readonly="readonly" name="cohort-review1" rows="4"
                                    cols="50">{{ $value->names }}</textarea>
                            </td>
                            <td>
                                <form>
