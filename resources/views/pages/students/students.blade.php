        ...
        <form class="student-form" action="{{ route('students.store') }}" method="POST">
            ...
            <div class="form-col">
                <div class="input-group">
                    ...
                    <input type="text" name="github_username" placeholder="GitHub Username" required>
                    <input type="email" name="student_email" placeholder="student@student.op.ac.nz" required>
                </div>
