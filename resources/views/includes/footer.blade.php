...
<footer class="footer">
  ...
  <div class="col">
   <h1>General enquiries</h1>
    ...
    <p>International +64 3 477 3014</p>
    <p>Email info@op.ac.nz</p>
     
  </div>
  <div class="col">
  <h1> Dunedin Campus </h1>
    <p>Forth Street, Private
      Bag 1910, Dunedin,
      9054, New Zealand
      New Zealand 0800 762 786
      International +64 3 477 3014
      Email info@op.ac.nz</p>
  </div>

  <div class="col">
    <h1>Central Campus </h1>
      <p>Bannockburn Road, 
        PO BOX 16, Cromwell 9342, 
        New Zealand

        0800 765 9276
        International +64 3 445 9900
        Email central@op.ac.nz</p>
  </div>

  <div class="col">
  <h1> Auckland Campus </h1>
    <p>Level 1, 350 Queen Street, 
